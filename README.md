...
-  method addRatinToOffice 
-  method calculateAverageRating
-  All table+controller+service+ repository and add security  (office,Rating,service)
- confirmCompanyAccount
- method SearchNumberPerson
- method SearchLocation
- method SearchNameCompany
- test repository
- method ExtendBooking
